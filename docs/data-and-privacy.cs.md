...
Jednotlivé záznamy se mažou v aplikaci. Když chcete pryč všechno, smažte datový adresář, adresář klíčů a zálohy — a zničte heslo. Protože je obsah šifrovaný tím klíčem, zničením klíče a jeho kopií se stane nečitelným i obsah kopie, na kterou jste zapomněli — kromě bezpečnostního logu, který šifrovaný není a je součástí každé zálohy databáze; ten je potřeba smazat ve všech kopiích.
